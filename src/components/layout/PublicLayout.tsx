    ...
    return (
        <div className="flex min-h-screen flex-col">
            <div className="relative overflow-hidden bg-gradient-to-br from-brand-800 via-brand-600 to-violet-600 pb-32 print:hidden">
                ...
                <header className="relative mx-auto flex max-w-2xl items-center gap-3 px-4 pt-8">
            ...
            <main className="relative mx-auto -mt-24 w-full max-w-2xl flex-1 px-4 pb-16 print:mt-0">
                {children}
            </main>
